...
class EzroApp:
    def __init__(self, master=None):
        ...
        tooltip.create(self.Config_Default_LetterFolder, 'If enabled, each rom will be exported to a parent folder named after the first letter of its highest-priority region.\n\nFor example, Castlevania will be exported to a [C] folder.\n\nIf unsure, leave this disabled.')
    ...
    def addSystemTab(self, systemName="New System", datFilePath="", romsetFolderPath="", outputFolderDirectory="",
        ...
        tooltip.create(self.Export_LetterFolder_[self.exportTabNum], 'If enabled, each rom will be exported to a parent folder named after the first letter of its highest-priority region.\n\nFor example, Castlevania will be exported to a [C] folder.\n\nIf unsure, leave this disabled.')
